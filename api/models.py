...
class Item(models.Model):
    ...
    product_type = models.CharField("Product Type", max_length=100, blank=True, null=True)
    images = models.CharField("Images", max_length=100, blank=True, null=True)
    body = models.TextField("Body", blank=True, null=True)
    price = models.IntegerField("Price", blank=True, null=True)
    is_in_stock = models.BooleanField("Is In Stock", default=False)
    ideal_for = models.CharField("Ideal For", max_length=20, blank=True, null=True)
